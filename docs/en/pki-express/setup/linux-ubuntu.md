...
In order to install PKI Express on Ubuntu (desktop or server) or on Linux Mint you will need a license file. If you don't have a license yet, [request a trial license](https://www.lacunasoftware.com/en/home/purchase).
