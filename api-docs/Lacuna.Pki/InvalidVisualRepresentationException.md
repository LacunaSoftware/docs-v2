---
sidebar_label: "InvalidVisualRepresentationException"
---
...
```csharp
public class InvalidVisualRepresentationException : InvalidParameterException, ISerializable, _Exception
```

**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → [`Exception`](https://learn.microsoft.com/dotnet/api/system.exception) → [`InvalidParameterException`](./InvalidParameterException.md) → `InvalidVisualRepresentationException`

## Construtores

### `InvalidVisualRepresentationException(string, Exception)` {#ctor-system-string-system-exception}

```csharp
public InvalidVisualRepresentationException(string message, Exception innerException)
```
...
### `InvalidVisualRepresentationException(string)` {#ctor-system-string}

```csharp
public InvalidVisualRepresentationException(string message)
```
