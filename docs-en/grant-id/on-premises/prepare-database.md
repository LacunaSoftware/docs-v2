...
Starting on [version 4.2.0](../changelog.md#v4-2-0) of GrantID, PostgreSQL is also supported. Any version currently supported of PostgreSQL
...
{/* ## See also * [Running GrantID without db_owner privileges](unprivileged-db-user.md) */}
