...
![Gerencianet API menu](/images/signer/gerencianet-api-menu.png)

No menu lateral, selecione a opção `Minhas aplicações` e clique no botão `Nova Aplicação`:

![Gerencianet create app](/images/signer/gerencianet-create-app.png)
...
1. Ative a API Pix e habilite os seguintes escopos de produção e homologação:
  ...
  * `Consultar Pix`
  * `Enviar Pix`
  ![Gerencianet API scopes](/images/signer/gerencianet-api-scopes.png)
