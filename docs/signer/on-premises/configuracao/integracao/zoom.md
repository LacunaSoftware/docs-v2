...
![Zoom Settings 1](/images/signer/zoom-rec-settings1.png)

![Zoom Settings 2](/images/signer/zoom-rec-settings2.png)
...
![Zoom S2S App S2S](/images/signer/zoom-s2s.png)
1. Dê um nome para seu aplicativo (pode ser o mesmo nome de sua instância do Assinador);
![Zoom S2S App Name](/images/signer/zoom-appname.png)
...
![Create Conference](/images/signer/create-conference.png)
