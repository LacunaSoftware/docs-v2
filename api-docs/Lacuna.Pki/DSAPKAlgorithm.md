...
**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → [`PKAlgorithm`](./PKAlgorithm.md) → `DSAPKAlgorithm`
...
### `GetCsp(DSAPublicKey)` {#getcsp-lacuna-pki-dsapublickey}
...
| Nome | Tipo | Descrição |
|---|---|---|
| `publicKey` | [`DSAPublicKey`](./DSAPublicKey.md) |  |

**Retorno**

[`DSACryptoServiceProvider`](https://learn.microsoft.com/dotnet/api/system.security.cryptography.dsacryptoserviceprovider)
