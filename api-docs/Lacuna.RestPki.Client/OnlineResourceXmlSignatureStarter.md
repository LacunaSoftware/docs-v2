---
sidebar_label: "OnlineResourceXmlSignatureStarter"
---
...
```csharp
public class OnlineResourceXmlSignatureStarter : XmlSignatureStarter
```

**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → [`SignatureStarter`](./SignatureStarter.md) → [`XmlSignatureStarter`](./XmlSignatureStarter.md) → `OnlineResourceXmlSignatureStarter`

## Construtores

### `OnlineResourceXmlSignatureStarter(RestPkiClient)` {#ctor-lacuna-restpki-client-restpkiclient}
