...
{/* include: ../../../includes/linux/rocky/install-aspnetcore-80.md */}
...
```sh
nano /etc/nginx/conf.d/grantid-identity-service.conf
```
...
```sh
nano /etc/nginx/conf.d/grantid-auth-server.conf
```
...
```sh
nano /etc/nginx/conf.d/grantid-console.conf
```
