...
**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → `TrustedRoots`
...
### `TrustedRoots(IEnumerable<PKCertificate>, IEnumerable<PKCertificate>)` {#ctor-system-collections-generic-ienumerable-lacuna-pki-pkcertificate-system-collections-generic-ienumerable-lacuna-pki-pkcertificate}
...
| Nome | Tipo | Descrição |
|---|---|---|
| `trustedRoots` | [`IEnumerable<PKCertificate>`](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1) |  |
| `intermediateCAs` | [`IEnumerable<PKCertificate>`](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1) |  |

---

### `TrustedRoots(IEnumerable<PKCertificate>)` {#ctor-system-collections-generic-ienumerable-lacuna-pki-pkcertificate}
...
### `TrustedRoots(params PKCertificate[])` {#ctor-lacuna-pki-pkcertificate}
...
| Nome | Tipo | Descrição |
|---|---|---|
| `trustedRoot` | [`PKCertificate`](./PKCertificate.md) |  |

---

### `AddIntermediateCAs(IEnumerable<PKCertificate>)` {#addintermediatecas-system-collections-generic-ienumerable-lacuna-pki-pkcertificate}
