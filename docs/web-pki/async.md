...
O código acima é um exemplo de uma **chamada assíncrona**. O método [`listCertificates()`](pathname:///content/typedocs/web-pki/classes/_lacuna_web_pki_d_.lacunawebpki.html#listcertificates) não pode fazer imediatamente todo o procedimento necessário e retornar o
...
imediatamente retorna uma **promessa** (uma instância da classe [`Promise`](pathname:///content/typedocs/web-pki/interfaces/_lacuna_web_pki_d_.promise.html).
...
erro durante a operação. Todos os métodos da classe [`Promise`](pathname:///content/typedocs/web-pki/interfaces/_lacuna_web_pki_d_.promise.html) são encadeáveis, ou seja, você pode fazer o seguinte:
...
Para mais informações sobre os parâmetros do objeto da exceção, veja a documentação do método [Promise.fail()](pathname:///content/typedocs/web-pki/interfaces/_lacuna_web_pki_d_.promise.html#fail) e [ExceptionModel](pathname:///content/typedocs/web-pki/interfaces/_lacuna_web_pki_d_.exceptionmodel.html).

:::note
Todos os métodos da classe [`LacunaWebPKI`](pathname:///content/typedocs/web-pki/classes/_lacuna_web_pki_d_.lacunawebpki.html) são assíncronos, com raras exceções.
:::
