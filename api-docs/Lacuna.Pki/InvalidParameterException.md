---
sidebar_label: "InvalidParameterException"
---
...
```csharp
public class InvalidParameterException : Exception, ISerializable, _Exception
```

**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → [`Exception`](https://learn.microsoft.com/dotnet/api/system.exception) → `InvalidParameterException`

## Construtores

### `InvalidParameterException(string, Exception)` {#ctor-system-string-system-exception}
...
### `InvalidParameterException(string)` {#ctor-system-string}
