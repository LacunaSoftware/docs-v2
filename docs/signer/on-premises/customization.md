...
![Color Scheme](/images/signer/themes/default.png)

* amaranth-pacific-blue - apb:

![Color Scheme](/images/signer/themes/apb.png)

* amazon-cornell-red - acr:

![Color Scheme](/images/signer/themes/acr.png)

* azure-lime-green - alg:

![Color Scheme](/images/signer/themes/alg.png)

* castleton-green-orange - cgo (v1.10.1):

![Color Scheme](/images/signer/themes/cgo.png)

* cerulean-lime-green - clg:

![Color Scheme](/images/signer/themes/clg.png)

* charcoal-amazonite - cam:

![Color Scheme](/images/signer/themes/cam.png)

* cobalt-lemon-curry - clc:

![Color Scheme](/images/signer/themes/clc.png)

* dark-cerulean-green - dcg:

![Color Scheme](/images/signer/themes/dcg.png)

* dark-grey-yellow - dgy:

![Color Scheme](/images/signer/themes/dgy.png)

* dark-indigo-red - dir:

![Color Scheme](/images/signer/themes/dir.png)

* english-vermillion-arsenic - eva:

![Color Scheme](/images/signer/themes/eva.png)

* green-dark-coral - gdc:

![Color Scheme](/images/signer/themes/gdc.png)

* independence-green - idg:

![Color Scheme](/images/signer/themes/idg.png)

* metallic-seaweed-emerald - mse:

![Color Scheme](/images/signer/themes/mse.png)

* onyx-satin-gold - osg:

![Color Scheme](/images/signer/themes/osg.png)

* oxford-blue-green - obg (v1.10.1):

![Color Scheme](/images/signer/themes/obg.png)

* persian-plum-sand - pps (v1.10.4):

![Color Scheme](/images/signer/themes/pps.png)

* queen-blue-mint - qbm:

![Color Scheme](/images/signer/themes/qbm.png)

* teal-blue-gold - tbg:

![Color Scheme](/images/signer/themes/tbg.png)

* viridian-green-yellow - vgy (v1.10.2):

![Color Scheme](/images/signer/themes/vgy.png)

* charcoal-orange-flame - cof (v1.26.1):

![Color Scheme](/images/signer/themes/cof.png)

* international-orange-green - iog (v1.31.0):

![Color Scheme](/images/signer/themes/iog.png)

* onyx-carrot-orange - oco (v1.31.0):

![Color Scheme](/images/signer/themes/oco.png)

* international-orange-apricot - ioa (v1.33.0):

![Color Scheme](/images/signer/themes/ioa.png)

* generic-viridian-blue - gvb (v1.33.0):

![Color Scheme](/images/signer/themes/gvb.png)

* space-cadet-yellow - scy (v1.34.0):

![Color Scheme](/images/signer/themes/scy.png)

* blue-venetian-red - bvr (v1.36.0):

![Color Scheme](/images/signer/themes/bvr.png)

* eminence-cornflower-blue - ecb (v1.39.1):

![Color Scheme](/images/signer/themes/ecb.png)

* vivid-sky-blue - vsb (v1.44.0):

![Color Scheme](/images/signer/themes/vsb.png)

* chartreuse-traditional-violet - ctv (v1.44.1):

![Color Scheme](/images/signer/themes/ctv.png)

* davys-maximum-green - dmg (v1.49.0):

![Color Scheme](/images/signer/themes/dmg.png)

* yale-blue-yellow - yby (v1.51.0):

![Color Scheme](/images/signer/themes/yby.png)

* silver-eerie-black - seb (v1.54.0):

![Color Scheme](/images/signer/themes/seb.png)

* zomp-ut-orange - zuo (v1.56.0):

![Color Scheme](/images/signer/themes/zuo.png)

* dim palatinate blue - dpb (v1.58.1):

![Color Scheme](/images/signer/themes/dpb.png)

* deep-jungle-princeton - djp (v1.59.0):

![Color Scheme](/images/signer/themes/djp.png)

* folly-russian-violet - frv (v1.68.0):

![Color Scheme](/images/signer/themes/frv.png)

* sea-green-yellow - sgy (v2.0.0):

![Color Scheme](/images/signer/themes/sgy.png)

* cyan-process-green - cpg (v2.0.0):

![Color Scheme](/images/signer/themes/cpg.png)

* prussian-blue-green - pbg (v2.3.0):

![Color Scheme](/images/signer/themes/pbg.png)
...
![Custom Home page advanced](/images/signer/advanced-home-page.png)
