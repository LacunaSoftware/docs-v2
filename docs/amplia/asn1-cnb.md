...
## 1. Políticas de certificado (*certificate policies*) {#cert-policies}
...
### 1.1. Política de certificados de tabeliães titulares {#notary-cert-policy}
...
### 1.2. Política de certificados em aplicativo móvel {#mobile-cert-policy}
...
### 1.3. Política de certificados de tabeliães substitutos {#notary-substitute-cert-policy}
