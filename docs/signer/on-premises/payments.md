...
![Update invoice status](/images/signer/invoice-status.png)
...
![Billing webhook](/images/signer/billing-webhook.png)
...
![Create application](/images/signer/create-application.png)

Em seguida gere a chave na opção "Chaves":

![Application keys](/images/signer/application-keys.png)

![Application create key](/images/signer/application-keys-add.png)

![Create key submit](/images/signer/create-key.png)
