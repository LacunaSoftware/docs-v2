---
sidebar_label: "InvalidCadesSignatureException"
---
...
```csharp
public class InvalidCadesSignatureException : Exception, ISerializable, _Exception
```

**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → [`Exception`](https://learn.microsoft.com/dotnet/api/system.exception) → `InvalidCadesSignatureException`

## Construtores

### `InvalidCadesSignatureException(string, Exception)` {#ctor-system-string-system-exception}

```csharp
public InvalidCadesSignatureException(string message, Exception innerException)
```
...
### `InvalidCadesSignatureException(string)` {#ctor-system-string}

```csharp
public InvalidCadesSignatureException(string message)
```
