---
sidebar_label: "PkiRsaPkcs1Sha512SignatureDescription"
---
...
**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → [`SignatureDescription`](https://learn.microsoft.com/dotnet/api/system.security.cryptography.signaturedescription) → [`PkiRsaPkcs1SignatureDescription`](./PkiRsaPkcs1SignatureDescription.md) → `PkiRsaPkcs1Sha512SignatureDescription`

## Construtores

### `PkiRsaPkcs1Sha512SignatureDescription()` {#ctor}
