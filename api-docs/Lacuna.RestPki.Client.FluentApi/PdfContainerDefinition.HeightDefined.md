---
sidebar_label: "PdfContainerDefinition.HeightDefined"
---
...
```csharp
public class PdfContainerDefinition.HeightDefined
```

**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → `PdfContainerDefinition.HeightDefined`
...
[`PadesVisualRectangle`](../Lacuna.RestPki.Client/PadesVisualRectangle.md)
...
```csharp
public PdfContainerDefinition.HeightDefinedVarWidth VarWidth()
```

**Retorno**

[`PdfContainerDefinition.HeightDefinedVarWidth`](./PdfContainerDefinition.HeightDefinedVarWidth.md)

---

### `Width(double)` {#width-system-double}

```csharp
public PdfContainerDefinition.HeightDefinedFixedWidth Width(double width)
```
...
[`PdfContainerDefinition.HeightDefinedFixedWidth`](./PdfContainerDefinition.HeightDefinedFixedWidth.md)
