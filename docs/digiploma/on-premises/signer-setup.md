---
sidebar_label: "Integração com o Signer"
sidebar_position: 3
---
...
![Adm](/images/digiploma/adm-sys-admin.png)

Selecione **Organizações**.

![Organizations](/images/digiploma/organizations.png)

### Digiploma
Clique em **Adicionar**

![AddOrganizationDigiploma](/images/digiploma/digiploma-add-organization.png)

Agora, basta preencher as informações necessárias, selecionar o tipo da organização e clicar em **Criar**. O apelido é opcional.

![SaveOrganization](/images/digiploma/digiploma-save-organization.png)
...
![NewOrganization](/images/digiploma/new-organization.png)

- Caso já exista alguma organização, clique no ícone **+**:

![AddOrganization](/images/digiploma/add-organization.png)
...
![Application keys](/images/digiploma/application-keys.png)

![Application create key](/images/digiploma/application-keys-add.png)

![Create key submit](/images/digiploma/create-key.png)
...
![Configurations](/images/digiploma/configuration.png)

![AddSignerKey](/images/digiploma/digiploma-add-signer-key.png)
...
![Applications](/images/digiploma/digiploma-applications.png)

![Create application](/images/digiploma/digiploma-create-application.png)
...
![EnableWebhooks](/images/digiploma/enable-webhooks.png)
...
![SetupWebhook](/images/digiploma/setup-webhook.png)
