---
sidebar_label: "SelfSignedPKCertificateGenerator"
---
...
**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → [`BasePKCertificateGenerator`](./BasePKCertificateGenerator.md) → `SelfSignedPKCertificateGenerator`

## Construtores

### `SelfSignedPKCertificateGenerator()` {#ctor}
...
[`PrivateKey`](../Lacuna.Pki/PrivateKey.md)
...
[`PKCertificate`](../Lacuna.Pki/PKCertificate.md) — Self-signed PKCertificate
