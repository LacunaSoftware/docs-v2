---
sidebar_label: "PkiRsaPkcs1Sha256SignatureDescription"
---
...
public class PkiRsaPkcs1Sha256SignatureDescription : PkiRsaPkcs1SignatureDescription
```

**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → [`SignatureDescription`](https://learn.microsoft.com/dotnet/api/system.security.cryptography.signaturedescription) → [`PkiRsaPkcs1SignatureDescription`](./PkiRsaPkcs1SignatureDescription.md) → `PkiRsaPkcs1Sha256SignatureDescription`

## Construtores

### `PkiRsaPkcs1Sha256SignatureDescription()` {#ctor}

```csharp
public PkiRsaPkcs1Sha256SignatureDescription()
```
