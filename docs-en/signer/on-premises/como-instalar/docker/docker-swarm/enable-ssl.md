---
unlisted: true
slug: /signer/on-premises/docker/docker-swarm/enable-ssl
---
...
{/* include: ../../../../../includes/signer/docker/remove-stack.md */}
...
{/* include: ../../../../../includes/signer/docker/create-ssl-cert-secret.md */}


Edit the Docker compose file:


{/* include: ../../../../../includes/signer/docker/edit-compose.md */}


Uncomment the following entries:


{/* include: ../../../../../includes/signer/docker/enable-ssl-docker-compose.md */}


Edit the Nginx configuration file:


{/* include: ../../../../../includes/signer/docker/edit-nginx-config.md */}


Uncomment the following entries:


{/* include: ../../../../../includes/signer/docker/enable-ssl-nginx-config.md */}


Edit the Signer configuration file:


{/* include: ../../../../../includes/signer/docker/edit-signer-config.md */}
...
{/* include: ../../../../../includes/signer/docker/deploy.md */}
