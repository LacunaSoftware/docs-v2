---
sidebar_label: "CertificateIssuerNotFoundException"
---
...
**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → [`Exception`](https://learn.microsoft.com/dotnet/api/system.exception) → `CertificateIssuerNotFoundException`
