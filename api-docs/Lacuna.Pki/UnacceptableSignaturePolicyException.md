---
sidebar_label: "UnacceptableSignaturePolicyException"
---
...
```csharp
public class UnacceptableSignaturePolicyException : Exception, ISerializable, _Exception
```

**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → [`Exception`](https://learn.microsoft.com/dotnet/api/system.exception) → `UnacceptableSignaturePolicyException`

## Construtores

### `UnacceptableSignaturePolicyException(string)` {#ctor-system-string}

```csharp
public UnacceptableSignaturePolicyException(string message)
```
