---
sidebar_label: "InvalidCsrException"
---
...
**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → [`Exception`](https://learn.microsoft.com/dotnet/api/system.exception) → `InvalidCsrException`

## Construtores

### `InvalidCsrException(string, Exception)` {#ctor-system-string-system-exception}
...
### `InvalidCsrException(string)` {#ctor-system-string}
