...
* [Documentação do método `sendAuthenticatedRequest()`](pathname:///content/typedocs/web-pki/classes/_lacuna_web_pki_d_.lacunawebpki.html#sendauthenticatedrequest) (disponível desde a [versão 1.4 da API](api-reference/versions.md#v1-4))