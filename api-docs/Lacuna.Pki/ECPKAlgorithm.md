...
```csharp
public class ECPKAlgorithm : PKAlgorithm
```

**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → [`PKAlgorithm`](./PKAlgorithm.md) → `ECPKAlgorithm`
