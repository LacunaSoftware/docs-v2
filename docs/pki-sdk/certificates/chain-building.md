...
A biblioteca oferece o uso de um store de certificados em memória (`Lacuna.Pki.Stores.MemoryCertificateStore`) e
...
`Lacuna.Pki.PKCertificate.Decode(System.Byte[],Lacuna.Pki.Stores.ICertificateStore)`
ou
