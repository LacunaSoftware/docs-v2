---
sidebar_label: "PkiRsaPkcs1MD5SignatureDescription"
---
...
**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → [`SignatureDescription`](https://learn.microsoft.com/dotnet/api/system.security.cryptography.signaturedescription) → [`PkiRsaPkcs1SignatureDescription`](./PkiRsaPkcs1SignatureDescription.md) → `PkiRsaPkcs1MD5SignatureDescription`

## Construtores

### `PkiRsaPkcs1MD5SignatureDescription()` {#ctor}
