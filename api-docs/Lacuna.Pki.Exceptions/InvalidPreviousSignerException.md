---
sidebar_label: "InvalidPreviousSignerException"
---

# InvalidPreviousSignerException
...
```csharp
public class InvalidPreviousSignerException : Exception, ISerializable, _Exception
```

**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → [`Exception`](https://learn.microsoft.com/dotnet/api/system.exception) → `InvalidPreviousSignerException`

## Construtores

### `InvalidPreviousSignerException()` {#ctor}

```csharp
public InvalidPreviousSignerException()
```
