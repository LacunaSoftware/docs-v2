...
:::info
As of version [1.4.0](../../changelog.md), Amplia Reg **no longer requires a Google Maps Embed API key**. This documentation is kept here
...
## Generate a Google Maps Embed API key {#gen-key}
