...
## Install the ASP.NET Core Runtime 8.0 {#install-aspnet-core}
...
curl -O https://cdn.lacunasoftware.com/signer/signer-2.21.0.tar.gz
tar xzf signer-2.21.0.tar.gz -C /usr/share/lacuna-signer
...
### General settings {#encryption-key-generation}
