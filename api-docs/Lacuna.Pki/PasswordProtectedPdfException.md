---
sidebar_label: "PasswordProtectedPdfException"
---
...
**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → [`Exception`](https://learn.microsoft.com/dotnet/api/system.exception) → `PasswordProtectedPdfException`

## Construtores

### `PasswordProtectedPdfException(string, Exception)` {#ctor-system-string-system-exception}
