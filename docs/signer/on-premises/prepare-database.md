...
{/* :::note Se você preferir operar o Signer sem conceder `db_owner` ao usuário da aplicação, siga as instruções [neste artigo](unprivileged-db-user.md) ::: */}
...
{/* ## See also [Operando o Signer sem ser *owner* do banco de dados](unprivileged-db-user.md) */}
