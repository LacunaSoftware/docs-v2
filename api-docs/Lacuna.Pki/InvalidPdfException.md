---
sidebar_label: "InvalidPdfException"
---
...
**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → [`Exception`](https://learn.microsoft.com/dotnet/api/system.exception) → `InvalidPdfException`

## Construtores

### `InvalidPdfException(string, Exception)` {#ctor-system-string-system-exception}
...
### `InvalidPdfException(string)` {#ctor-system-string}
