---
sidebar_label: "SignedPdfToMarkException"
---

# SignedPdfToMarkException
...
```csharp
public class SignedPdfToMarkException : Exception, ISerializable, _Exception
```

**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → [`Exception`](https://learn.microsoft.com/dotnet/api/system.exception) → `SignedPdfToMarkException`

## Construtores

### `SignedPdfToMarkException(string)` {#ctor-system-string}

```csharp
public SignedPdfToMarkException(string message)
```
