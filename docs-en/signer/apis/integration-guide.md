...
### Pre-positioning a signature on the document {#document-marks}
...
### Check the document status {#check-document}
...
### Send signing reminders {#document-reminders}
...
### Validate document's signatures {#validate-signatures}
