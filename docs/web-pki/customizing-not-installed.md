...
`init()` (consulte a [documentação do método](pathname:///content/typedocs/web-pki/classes/_lacuna_web_pki_d_.lacunawebpki.html#init) para mais detalhes) e passar um callback
