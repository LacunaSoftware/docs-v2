---
sidebar_label: "XmlElementSignatureStarter"
---
...
```csharp
public class XmlElementSignatureStarter : XmlSignatureStarter
```

**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → [`SignatureStarter`](./SignatureStarter.md) → [`XmlSignatureStarter`](./XmlSignatureStarter.md) → `XmlElementSignatureStarter`

## Construtores

### `XmlElementSignatureStarter(RestPkiClient)` {#ctor-lacuna-restpki-client-restpkiclient}
...
### `SetIdResolutionTable(XmlIdResolutionTable)` {#setidresolutiontable-lacuna-restpki-client-xmlidresolutiontable}
...
| Nome | Tipo | Descrição |
|---|---|---|
| `elementId` | [`string`](https://learn.microsoft.com/dotnet/api/system.string) |  |
