---
sidebar_label: "LicenseException"
---
...
**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → [`Exception`](https://learn.microsoft.com/dotnet/api/system.exception) → `LicenseException`

## Construtores

### `LicenseException()` {#ctor}
...
### `LicenseException(string, Exception)` {#ctor-system-string-system-exception}
...
### `LicenseException(string)` {#ctor-system-string}
