---
sidebar_label: "Preparing the Database"
sidebar_position: 6
---
...
{/* :::note If you prefer to operate the Signer without giving `db_owner` to the application user, follow the instructions [in this article](unprivileged-db-user.md) ::: */}
...
{/* ## See also [Operating the Signer without being an * owner * of the database](unprivileged-db-user.md) */}
