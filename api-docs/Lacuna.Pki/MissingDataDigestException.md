---
sidebar_label: "MissingDataDigestException"
---
...
**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → [`Exception`](https://learn.microsoft.com/dotnet/api/system.exception) → `MissingDataDigestException`

## Construtores

### `MissingDataDigestException(DigestAlgorithm)` {#ctor-lacuna-pki-digestalgorithm}
