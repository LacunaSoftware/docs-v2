---
sidebar_label: "PadesSignatureFinisher2"
---
...
```csharp
public class PadesSignatureFinisher2 : SignatureFinisher2
```

**Hierarquia:** [`object`](https://learn.microsoft.com/dotnet/api/system.object) → [`SignatureFinisher2`](./SignatureFinisher2.md) → `PadesSignatureFinisher2`

## Construtores

### `PadesSignatureFinisher2(RestPkiClient)` {#ctor-lacuna-restpki-client-restpkiclient}
